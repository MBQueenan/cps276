...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mbbryson';//this will be your WCC username
      $dbUsr = 'mbbryson';//this will be your WCC username
      $dbPass = 'ffuwvkDQsYX8';//this will be the password found in the video.
