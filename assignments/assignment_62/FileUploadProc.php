...
class Upload{
    ...
    private $uploads_dir = "~mbbryson/cps276/assignments/assignment_62/files";
    ...
    function moveFile(){
        ...
        if(is_uploaded_file($this->enteredFileName) == false){
            move_uploaded_file($_FILES["selectedFile"]["tmp_name"], ($this->enteredFileName));
